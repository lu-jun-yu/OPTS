...
implement OPTS_TTPO-like algorithms.
"""
...
def compute_policy_loss_vanilla(
    ...
    # Apply direct branch weights for TTPO gradient correction
    if branch_weight is not None:
        pg_loss = agg_loss(
            loss_mat=pg_losses,
...
def compute_equal_branch_weight(
    ...
    products along the way. At the root, includes the reciprocal number of root
    trajectories under the same uid (tree).
    ...
    branch_factor = init_weights.unsqueeze(1) * cumulative
