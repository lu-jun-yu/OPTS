...
from trainer.opts_ttpo.core_algos_exp8_2 import (
    compute_treegae_advantage_return,
)
from trainer.opts_ttpo.ray_trainer_exp8_2 import (
    PromptBuffer,
...
def main_task(config):
    ...
    max_search_ratio = float(config.algorithm.get("max_search_ratio", 1.0))
    ...
    max_search_batch_size = int(max_search_ratio * effective_batch_size)
    ...
    print(f"Starting inference-time search: "
          ...
          f"max_search_ratio={max_search_ratio}, max_search_batch_size={max_search_batch_size}, "
