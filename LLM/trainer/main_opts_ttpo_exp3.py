...
from trainer.opts_ttpo.ray_trainer_exp3 import RayOPTSTTPOTrainer, need_critic_for_opts
...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        from trainer.opts_ttpo.ray_trainer_exp3 import Role
    ...
    def init_resource_pool_mgr(self, config):
        ...
        if config.reward_model.enable_resource_pool:
            ...
            from trainer.opts_ttpo.ray_trainer_exp3 import ResourcePoolManager
