...
from trainer.opts_ttpo.ray_trainer_exp8 import RayOPTSTTPOTrainer, need_critic_for_opts
...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        from trainer.opts_ttpo.ray_trainer_exp8 import Role
    ...
    def init_resource_pool_mgr(self, config):
        ...
        from trainer.opts_ttpo.ray_trainer_exp8 import ResourcePoolManager
