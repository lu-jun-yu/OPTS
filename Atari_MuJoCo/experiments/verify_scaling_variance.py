...
def collect_opts(env, agent, num_steps, device, max_search, tau, gamma, gae_lambda):
    """收集 OPTS rollout（不缓存：OPTS 算法常改动，缓存会过期）"""
...
if __name__ == "__main__":
    ...
    opts_obs, opts_act, opts_adv, opts_weights = collect_opts(
        env_opts, agent, args.num_steps, device,
